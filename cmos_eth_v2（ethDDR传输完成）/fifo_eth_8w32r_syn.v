...
//a_gray2bin device_family="Cyclone IV E" WIDTH=12 bin gray
...
module  fifo_eth_8w32r_a_gray2bin
	( 
	bin,
	...
	assign
		...
		xor8 = (gray[8] ^ xor9),
		xor9 = (gray[9] ^ xor10);
endmodule //fifo_eth_8w32r_a_gray2bin
...
module  fifo_eth_8w32r_a_graycounter
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) counter5a[11:11] <= 1'b0;
			...
			else  counter5a[11:11] <= (counter5a[11:11] ^ cntr_cout[10]);
	// synopsys translate_off
	initial
		parity6 = {1{1'b1}};
	// synopsys translate_on
	...
	assign
		cntr_cout = {1'b0, (cntr_cout[9] & (~ counter5a[9:9])), (cntr_cout[8] & (~ counter5a[8:8])), (cntr_cout[7] & (~ counter5a[7:7])), (cntr_cout[6] & (~ counter5a[6:6])), (cntr_cout[5] & (~ counter5a[5:5])), (cntr_cout[4] & (~ counter5a[4:4])), (cntr_cout[3] & (~ counter5a[3:3])), (cntr_cout[2] & (~ counter5a[2:2])), (cntr_cout[1] & (~ counter5a[1:1])), (cntr_cout[0] & (~ counter5a[0:0])), (cnt_en & parity_cout)},
		parity_cout = (((~ parity6) ^ updown) & cnt_en),
		q = counter5a,
		sclr = 1'b0,
		updown = 1'b1;
endmodule //fifo_eth_8w32r_a_graycounter


//a_graycounter DEVICE_FAMILY="Cyclone IV E" PVALUE=1 WIDTH=12 aclr clock cnt_en q ALTERA_INTERNAL_OPTIONS=suppress_da_rule_internal=S102
//VERSION_BEGIN 13.1 cbx_a_gray2bin 2013:10:23:18:05:48:SJ cbx_a_graycounter 2013:10:23:18:05:48:SJ cbx_cycloneii 2013:10:23:18:05:48:SJ cbx_mgl 2013:10:23:18:06:54:SJ cbx_stratix 2013:10:23:18:05:48:SJ cbx_stratixii 2013:10:23:18:05:48:SJ  VERSION_END
...
module  fifo_eth_8w32r_a_graycounter1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) counter8a[11:11] <= 1'b0;
			...
			else  counter8a[11:11] <= (counter8a[11:11] ^ cntr_cout[10]);
	// synopsys translate_off
	initial
		parity9 = {1{1'b1}};
	// synopsys translate_on
	...
	assign
		cntr_cout = {1'b0, (cntr_cout[9] & (~ counter8a[9:9])), (cntr_cout[8] & (~ counter8a[8:8])), (cntr_cout[7] & (~ counter8a[7:7])), (cntr_cout[6] & (~ counter8a[6:6])), (cntr_cout[5] & (~ counter8a[5:5])), (cntr_cout[4] & (~ counter8a[4:4])), (cntr_cout[3] & (~ counter8a[3:3])), (cntr_cout[2] & (~ counter8a[2:2])), (cntr_cout[1] & (~ counter8a[1:1])), (cntr_cout[0] & (~ counter8a[0:0])), (cnt_en & parity_cout)},
		parity_cout = (((~ parity9) ^ updown) & cnt_en),
		q = counter8a,
		sclr = 1'b0,
		updown = 1'b1;
endmodule //fifo_eth_8w32r_a_graycounter1


//altsyncram ADDRESS_ACLR_B="CLEAR1" ADDRESS_REG_B="CLOCK1" CLOCK_ENABLE_INPUT_B="BYPASS" DEVICE_FAMILY="Cyclone IV E" OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="CLEAR1" OUTDATA_REG_B="CLOCK1" WIDTH_A=32 WIDTH_B=32 WIDTH_BYTEENA_A=1 WIDTHAD_A=11 WIDTHAD_B=11 aclr1 address_a address_b addressstall_b clock0 clock1 clocken1 data_a q_b wren_a
...
module  fifo_eth_8w32r_altsyncram
	( 
	aclr1,
	address_a,
	address_b,
...
`endif
	...
	defparam
		...
		ram_block11a_0.port_a_address_width = 11,
		ram_block11a_0.port_a_data_width = 1,
		ram_block11a_0.port_a_first_address = 0,
		ram_block11a_0.port_a_first_bit_number = 0,
		ram_block11a_0.port_a_last_address = 2047,
		ram_block11a_0.port_a_logical_ram_depth = 2048,
		ram_block11a_0.port_a_logical_ram_width = 32,
		ram_block11a_0.port_b_address_clear = "clear1",
		ram_block11a_0.port_b_address_clock = "clock1",
		ram_block11a_0.port_b_address_width = 11,
		...
		ram_block11a_0.port_b_last_address = 2047,
		ram_block11a_0.port_b_logical_ram_depth = 2048,
		ram_block11a_0.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_1.port_a_address_width = 11,
		ram_block11a_1.port_a_data_width = 1,
		ram_block11a_1.port_a_first_address = 0,
		ram_block11a_1.port_a_first_bit_number = 1,
		ram_block11a_1.port_a_last_address = 2047,
		ram_block11a_1.port_a_logical_ram_depth = 2048,
		ram_block11a_1.port_a_logical_ram_width = 32,
		ram_block11a_1.port_b_address_clear = "clear1",
		ram_block11a_1.port_b_address_clock = "clock1",
		ram_block11a_1.port_b_address_width = 11,
		...
		ram_block11a_1.port_b_last_address = 2047,
		ram_block11a_1.port_b_logical_ram_depth = 2048,
		ram_block11a_1.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_2.port_a_address_width = 11,
		ram_block11a_2.port_a_data_width = 1,
		ram_block11a_2.port_a_first_address = 0,
		ram_block11a_2.port_a_first_bit_number = 2,
		ram_block11a_2.port_a_last_address = 2047,
		ram_block11a_2.port_a_logical_ram_depth = 2048,
		ram_block11a_2.port_a_logical_ram_width = 32,
		ram_block11a_2.port_b_address_clear = "clear1",
		ram_block11a_2.port_b_address_clock = "clock1",
		ram_block11a_2.port_b_address_width = 11,
		...
		ram_block11a_2.port_b_last_address = 2047,
		ram_block11a_2.port_b_logical_ram_depth = 2048,
		ram_block11a_2.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_3.port_a_address_width = 11,
		ram_block11a_3.port_a_data_width = 1,
		ram_block11a_3.port_a_first_address = 0,
		ram_block11a_3.port_a_first_bit_number = 3,
		ram_block11a_3.port_a_last_address = 2047,
		ram_block11a_3.port_a_logical_ram_depth = 2048,
		ram_block11a_3.port_a_logical_ram_width = 32,
		ram_block11a_3.port_b_address_clear = "clear1",
		ram_block11a_3.port_b_address_clock = "clock1",
		ram_block11a_3.port_b_address_width = 11,
		...
		ram_block11a_3.port_b_last_address = 2047,
		ram_block11a_3.port_b_logical_ram_depth = 2048,
		ram_block11a_3.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_4.port_a_address_width = 11,
		ram_block11a_4.port_a_data_width = 1,
		ram_block11a_4.port_a_first_address = 0,
		ram_block11a_4.port_a_first_bit_number = 4,
		ram_block11a_4.port_a_last_address = 2047,
		ram_block11a_4.port_a_logical_ram_depth = 2048,
		ram_block11a_4.port_a_logical_ram_width = 32,
		ram_block11a_4.port_b_address_clear = "clear1",
		ram_block11a_4.port_b_address_clock = "clock1",
		ram_block11a_4.port_b_address_width = 11,
		...
		ram_block11a_4.port_b_last_address = 2047,
		ram_block11a_4.port_b_logical_ram_depth = 2048,
		ram_block11a_4.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_5.port_a_address_width = 11,
		ram_block11a_5.port_a_data_width = 1,
		ram_block11a_5.port_a_first_address = 0,
		ram_block11a_5.port_a_first_bit_number = 5,
		ram_block11a_5.port_a_last_address = 2047,
		ram_block11a_5.port_a_logical_ram_depth = 2048,
		ram_block11a_5.port_a_logical_ram_width = 32,
		ram_block11a_5.port_b_address_clear = "clear1",
		ram_block11a_5.port_b_address_clock = "clock1",
		ram_block11a_5.port_b_address_width = 11,
		...
		ram_block11a_5.port_b_last_address = 2047,
		ram_block11a_5.port_b_logical_ram_depth = 2048,
		ram_block11a_5.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_6.port_a_address_width = 11,
		ram_block11a_6.port_a_data_width = 1,
		ram_block11a_6.port_a_first_address = 0,
		ram_block11a_6.port_a_first_bit_number = 6,
		ram_block11a_6.port_a_last_address = 2047,
		ram_block11a_6.port_a_logical_ram_depth = 2048,
		ram_block11a_6.port_a_logical_ram_width = 32,
		ram_block11a_6.port_b_address_clear = "clear1",
		ram_block11a_6.port_b_address_clock = "clock1",
		ram_block11a_6.port_b_address_width = 11,
		...
		ram_block11a_6.port_b_last_address = 2047,
		ram_block11a_6.port_b_logical_ram_depth = 2048,
		ram_block11a_6.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_7.port_a_address_width = 11,
		ram_block11a_7.port_a_data_width = 1,
		ram_block11a_7.port_a_first_address = 0,
		ram_block11a_7.port_a_first_bit_number = 7,
		ram_block11a_7.port_a_last_address = 2047,
		ram_block11a_7.port_a_logical_ram_depth = 2048,
		ram_block11a_7.port_a_logical_ram_width = 32,
		ram_block11a_7.port_b_address_clear = "clear1",
		ram_block11a_7.port_b_address_clock = "clock1",
		ram_block11a_7.port_b_address_width = 11,
		...
		ram_block11a_7.port_b_last_address = 2047,
		ram_block11a_7.port_b_logical_ram_depth = 2048,
		ram_block11a_7.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_8.port_a_address_width = 11,
		ram_block11a_8.port_a_data_width = 1,
		ram_block11a_8.port_a_first_address = 0,
		ram_block11a_8.port_a_first_bit_number = 8,
		ram_block11a_8.port_a_last_address = 2047,
		ram_block11a_8.port_a_logical_ram_depth = 2048,
		ram_block11a_8.port_a_logical_ram_width = 32,
		ram_block11a_8.port_b_address_clear = "clear1",
		ram_block11a_8.port_b_address_clock = "clock1",
		ram_block11a_8.port_b_address_width = 11,
		...
		ram_block11a_8.port_b_last_address = 2047,
		ram_block11a_8.port_b_logical_ram_depth = 2048,
		ram_block11a_8.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_9.port_a_address_width = 11,
		ram_block11a_9.port_a_data_width = 1,
		ram_block11a_9.port_a_first_address = 0,
		ram_block11a_9.port_a_first_bit_number = 9,
		ram_block11a_9.port_a_last_address = 2047,
		ram_block11a_9.port_a_logical_ram_depth = 2048,
		ram_block11a_9.port_a_logical_ram_width = 32,
		ram_block11a_9.port_b_address_clear = "clear1",
		ram_block11a_9.port_b_address_clock = "clock1",
		ram_block11a_9.port_b_address_width = 11,
		...
		ram_block11a_9.port_b_last_address = 2047,
		ram_block11a_9.port_b_logical_ram_depth = 2048,
		ram_block11a_9.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_10.port_a_address_width = 11,
		ram_block11a_10.port_a_data_width = 1,
		ram_block11a_10.port_a_first_address = 0,
		ram_block11a_10.port_a_first_bit_number = 10,
		ram_block11a_10.port_a_last_address = 2047,
		ram_block11a_10.port_a_logical_ram_depth = 2048,
		ram_block11a_10.port_a_logical_ram_width = 32,
		ram_block11a_10.port_b_address_clear = "clear1",
		ram_block11a_10.port_b_address_clock = "clock1",
		ram_block11a_10.port_b_address_width = 11,
		...
		ram_block11a_10.port_b_last_address = 2047,
		ram_block11a_10.port_b_logical_ram_depth = 2048,
		ram_block11a_10.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_11.port_a_address_width = 11,
		ram_block11a_11.port_a_data_width = 1,
		ram_block11a_11.port_a_first_address = 0,
		ram_block11a_11.port_a_first_bit_number = 11,
		ram_block11a_11.port_a_last_address = 2047,
		ram_block11a_11.port_a_logical_ram_depth = 2048,
		ram_block11a_11.port_a_logical_ram_width = 32,
		ram_block11a_11.port_b_address_clear = "clear1",
		ram_block11a_11.port_b_address_clock = "clock1",
		ram_block11a_11.port_b_address_width = 11,
		...
		ram_block11a_11.port_b_last_address = 2047,
		ram_block11a_11.port_b_logical_ram_depth = 2048,
		ram_block11a_11.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_12.port_a_address_width = 11,
		ram_block11a_12.port_a_data_width = 1,
		ram_block11a_12.port_a_first_address = 0,
		ram_block11a_12.port_a_first_bit_number = 12,
		ram_block11a_12.port_a_last_address = 2047,
		ram_block11a_12.port_a_logical_ram_depth = 2048,
		ram_block11a_12.port_a_logical_ram_width = 32,
		ram_block11a_12.port_b_address_clear = "clear1",
		ram_block11a_12.port_b_address_clock = "clock1",
		ram_block11a_12.port_b_address_width = 11,
		...
		ram_block11a_12.port_b_last_address = 2047,
		ram_block11a_12.port_b_logical_ram_depth = 2048,
		ram_block11a_12.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_13.port_a_address_width = 11,
		ram_block11a_13.port_a_data_width = 1,
		ram_block11a_13.port_a_first_address = 0,
		ram_block11a_13.port_a_first_bit_number = 13,
		ram_block11a_13.port_a_last_address = 2047,
		ram_block11a_13.port_a_logical_ram_depth = 2048,
		ram_block11a_13.port_a_logical_ram_width = 32,
		ram_block11a_13.port_b_address_clear = "clear1",
		ram_block11a_13.port_b_address_clock = "clock1",
		ram_block11a_13.port_b_address_width = 11,
		...
		ram_block11a_13.port_b_last_address = 2047,
		ram_block11a_13.port_b_logical_ram_depth = 2048,
		ram_block11a_13.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_14.port_a_address_width = 11,
		ram_block11a_14.port_a_data_width = 1,
		ram_block11a_14.port_a_first_address = 0,
		ram_block11a_14.port_a_first_bit_number = 14,
		ram_block11a_14.port_a_last_address = 2047,
		ram_block11a_14.port_a_logical_ram_depth = 2048,
		ram_block11a_14.port_a_logical_ram_width = 32,
		ram_block11a_14.port_b_address_clear = "clear1",
		ram_block11a_14.port_b_address_clock = "clock1",
		ram_block11a_14.port_b_address_width = 11,
		...
		ram_block11a_14.port_b_last_address = 2047,
		ram_block11a_14.port_b_logical_ram_depth = 2048,
		ram_block11a_14.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_15.port_a_address_width = 11,
		ram_block11a_15.port_a_data_width = 1,
		ram_block11a_15.port_a_first_address = 0,
		ram_block11a_15.port_a_first_bit_number = 15,
		ram_block11a_15.port_a_last_address = 2047,
		ram_block11a_15.port_a_logical_ram_depth = 2048,
		ram_block11a_15.port_a_logical_ram_width = 32,
		ram_block11a_15.port_b_address_clear = "clear1",
		ram_block11a_15.port_b_address_clock = "clock1",
		ram_block11a_15.port_b_address_width = 11,
		...
		ram_block11a_15.port_b_last_address = 2047,
		ram_block11a_15.port_b_logical_ram_depth = 2048,
		ram_block11a_15.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_16.port_a_address_width = 11,
		ram_block11a_16.port_a_data_width = 1,
		ram_block11a_16.port_a_first_address = 0,
		ram_block11a_16.port_a_first_bit_number = 16,
		ram_block11a_16.port_a_last_address = 2047,
		ram_block11a_16.port_a_logical_ram_depth = 2048,
		ram_block11a_16.port_a_logical_ram_width = 32,
		ram_block11a_16.port_b_address_clear = "clear1",
		ram_block11a_16.port_b_address_clock = "clock1",
		ram_block11a_16.port_b_address_width = 11,
		...
		ram_block11a_16.port_b_last_address = 2047,
		ram_block11a_16.port_b_logical_ram_depth = 2048,
		ram_block11a_16.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_17.port_a_address_width = 11,
		ram_block11a_17.port_a_data_width = 1,
		ram_block11a_17.port_a_first_address = 0,
		ram_block11a_17.port_a_first_bit_number = 17,
		ram_block11a_17.port_a_last_address = 2047,
		ram_block11a_17.port_a_logical_ram_depth = 2048,
		ram_block11a_17.port_a_logical_ram_width = 32,
		ram_block11a_17.port_b_address_clear = "clear1",
		ram_block11a_17.port_b_address_clock = "clock1",
		ram_block11a_17.port_b_address_width = 11,
		...
		ram_block11a_17.port_b_last_address = 2047,
		ram_block11a_17.port_b_logical_ram_depth = 2048,
		ram_block11a_17.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_18.port_a_address_width = 11,
		ram_block11a_18.port_a_data_width = 1,
		ram_block11a_18.port_a_first_address = 0,
		ram_block11a_18.port_a_first_bit_number = 18,
		ram_block11a_18.port_a_last_address = 2047,
		ram_block11a_18.port_a_logical_ram_depth = 2048,
		ram_block11a_18.port_a_logical_ram_width = 32,
		ram_block11a_18.port_b_address_clear = "clear1",
		ram_block11a_18.port_b_address_clock = "clock1",
		ram_block11a_18.port_b_address_width = 11,
		...
		ram_block11a_18.port_b_last_address = 2047,
		ram_block11a_18.port_b_logical_ram_depth = 2048,
		ram_block11a_18.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_19.port_a_address_width = 11,
		ram_block11a_19.port_a_data_width = 1,
		ram_block11a_19.port_a_first_address = 0,
		ram_block11a_19.port_a_first_bit_number = 19,
		ram_block11a_19.port_a_last_address = 2047,
		ram_block11a_19.port_a_logical_ram_depth = 2048,
		ram_block11a_19.port_a_logical_ram_width = 32,
		ram_block11a_19.port_b_address_clear = "clear1",
		ram_block11a_19.port_b_address_clock = "clock1",
		ram_block11a_19.port_b_address_width = 11,
		...
		ram_block11a_19.port_b_last_address = 2047,
		ram_block11a_19.port_b_logical_ram_depth = 2048,
		ram_block11a_19.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_20.port_a_address_width = 11,
		ram_block11a_20.port_a_data_width = 1,
		ram_block11a_20.port_a_first_address = 0,
		ram_block11a_20.port_a_first_bit_number = 20,
		ram_block11a_20.port_a_last_address = 2047,
		ram_block11a_20.port_a_logical_ram_depth = 2048,
		ram_block11a_20.port_a_logical_ram_width = 32,
		ram_block11a_20.port_b_address_clear = "clear1",
		ram_block11a_20.port_b_address_clock = "clock1",
		ram_block11a_20.port_b_address_width = 11,
		...
		ram_block11a_20.port_b_last_address = 2047,
		ram_block11a_20.port_b_logical_ram_depth = 2048,
		ram_block11a_20.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_21.port_a_address_width = 11,
		ram_block11a_21.port_a_data_width = 1,
		ram_block11a_21.port_a_first_address = 0,
		ram_block11a_21.port_a_first_bit_number = 21,
		ram_block11a_21.port_a_last_address = 2047,
		ram_block11a_21.port_a_logical_ram_depth = 2048,
		ram_block11a_21.port_a_logical_ram_width = 32,
		ram_block11a_21.port_b_address_clear = "clear1",
		ram_block11a_21.port_b_address_clock = "clock1",
		ram_block11a_21.port_b_address_width = 11,
		...
		ram_block11a_21.port_b_last_address = 2047,
		ram_block11a_21.port_b_logical_ram_depth = 2048,
		ram_block11a_21.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_22.port_a_address_width = 11,
		ram_block11a_22.port_a_data_width = 1,
		ram_block11a_22.port_a_first_address = 0,
		ram_block11a_22.port_a_first_bit_number = 22,
		ram_block11a_22.port_a_last_address = 2047,
		ram_block11a_22.port_a_logical_ram_depth = 2048,
		ram_block11a_22.port_a_logical_ram_width = 32,
		ram_block11a_22.port_b_address_clear = "clear1",
		ram_block11a_22.port_b_address_clock = "clock1",
		ram_block11a_22.port_b_address_width = 11,
		...
		ram_block11a_22.port_b_last_address = 2047,
		ram_block11a_22.port_b_logical_ram_depth = 2048,
		ram_block11a_22.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_23.port_a_address_width = 11,
		ram_block11a_23.port_a_data_width = 1,
		ram_block11a_23.port_a_first_address = 0,
		ram_block11a_23.port_a_first_bit_number = 23,
		ram_block11a_23.port_a_last_address = 2047,
		ram_block11a_23.port_a_logical_ram_depth = 2048,
		ram_block11a_23.port_a_logical_ram_width = 32,
		ram_block11a_23.port_b_address_clear = "clear1",
		ram_block11a_23.port_b_address_clock = "clock1",
		ram_block11a_23.port_b_address_width = 11,
		...
		ram_block11a_23.port_b_last_address = 2047,
		ram_block11a_23.port_b_logical_ram_depth = 2048,
		ram_block11a_23.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_24.port_a_address_width = 11,
		ram_block11a_24.port_a_data_width = 1,
		ram_block11a_24.port_a_first_address = 0,
		ram_block11a_24.port_a_first_bit_number = 24,
		ram_block11a_24.port_a_last_address = 2047,
		ram_block11a_24.port_a_logical_ram_depth = 2048,
		ram_block11a_24.port_a_logical_ram_width = 32,
		ram_block11a_24.port_b_address_clear = "clear1",
		ram_block11a_24.port_b_address_clock = "clock1",
		ram_block11a_24.port_b_address_width = 11,
		...
		ram_block11a_24.port_b_last_address = 2047,
		ram_block11a_24.port_b_logical_ram_depth = 2048,
		ram_block11a_24.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_25.port_a_address_width = 11,
		ram_block11a_25.port_a_data_width = 1,
		ram_block11a_25.port_a_first_address = 0,
		ram_block11a_25.port_a_first_bit_number = 25,
		ram_block11a_25.port_a_last_address = 2047,
		ram_block11a_25.port_a_logical_ram_depth = 2048,
		ram_block11a_25.port_a_logical_ram_width = 32,
		ram_block11a_25.port_b_address_clear = "clear1",
		ram_block11a_25.port_b_address_clock = "clock1",
		ram_block11a_25.port_b_address_width = 11,
		...
		ram_block11a_25.port_b_last_address = 2047,
		ram_block11a_25.port_b_logical_ram_depth = 2048,
		ram_block11a_25.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_26.port_a_address_width = 11,
		ram_block11a_26.port_a_data_width = 1,
		ram_block11a_26.port_a_first_address = 0,
		ram_block11a_26.port_a_first_bit_number = 26,
		ram_block11a_26.port_a_last_address = 2047,
		ram_block11a_26.port_a_logical_ram_depth = 2048,
		ram_block11a_26.port_a_logical_ram_width = 32,
		ram_block11a_26.port_b_address_clear = "clear1",
		ram_block11a_26.port_b_address_clock = "clock1",
		ram_block11a_26.port_b_address_width = 11,
		...
		ram_block11a_26.port_b_last_address = 2047,
		ram_block11a_26.port_b_logical_ram_depth = 2048,
		ram_block11a_26.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_27.port_a_address_width = 11,
		ram_block11a_27.port_a_data_width = 1,
		ram_block11a_27.port_a_first_address = 0,
		ram_block11a_27.port_a_first_bit_number = 27,
		ram_block11a_27.port_a_last_address = 2047,
		ram_block11a_27.port_a_logical_ram_depth = 2048,
		ram_block11a_27.port_a_logical_ram_width = 32,
		ram_block11a_27.port_b_address_clear = "clear1",
		ram_block11a_27.port_b_address_clock = "clock1",
		ram_block11a_27.port_b_address_width = 11,
		...
		ram_block11a_27.port_b_last_address = 2047,
		ram_block11a_27.port_b_logical_ram_depth = 2048,
		ram_block11a_27.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_28.port_a_address_width = 11,
		ram_block11a_28.port_a_data_width = 1,
		ram_block11a_28.port_a_first_address = 0,
		ram_block11a_28.port_a_first_bit_number = 28,
		ram_block11a_28.port_a_last_address = 2047,
		ram_block11a_28.port_a_logical_ram_depth = 2048,
		ram_block11a_28.port_a_logical_ram_width = 32,
		ram_block11a_28.port_b_address_clear = "clear1",
		ram_block11a_28.port_b_address_clock = "clock1",
		ram_block11a_28.port_b_address_width = 11,
		...
		ram_block11a_28.port_b_last_address = 2047,
		ram_block11a_28.port_b_logical_ram_depth = 2048,
		ram_block11a_28.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_29.port_a_address_width = 11,
		ram_block11a_29.port_a_data_width = 1,
		ram_block11a_29.port_a_first_address = 0,
		ram_block11a_29.port_a_first_bit_number = 29,
		ram_block11a_29.port_a_last_address = 2047,
		ram_block11a_29.port_a_logical_ram_depth = 2048,
		ram_block11a_29.port_a_logical_ram_width = 32,
		ram_block11a_29.port_b_address_clear = "clear1",
		ram_block11a_29.port_b_address_clock = "clock1",
		ram_block11a_29.port_b_address_width = 11,
		...
		ram_block11a_29.port_b_last_address = 2047,
		ram_block11a_29.port_b_logical_ram_depth = 2048,
		ram_block11a_29.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_30.port_a_address_width = 11,
		ram_block11a_30.port_a_data_width = 1,
		ram_block11a_30.port_a_first_address = 0,
		ram_block11a_30.port_a_first_bit_number = 30,
		ram_block11a_30.port_a_last_address = 2047,
		ram_block11a_30.port_a_logical_ram_depth = 2048,
		ram_block11a_30.port_a_logical_ram_width = 32,
		ram_block11a_30.port_b_address_clear = "clear1",
		ram_block11a_30.port_b_address_clock = "clock1",
		ram_block11a_30.port_b_address_width = 11,
		...
		ram_block11a_30.port_b_last_address = 2047,
		ram_block11a_30.port_b_logical_ram_depth = 2048,
		ram_block11a_30.port_b_logical_ram_width = 32,
	...
	defparam
		...
		ram_block11a_31.port_a_address_width = 11,
		ram_block11a_31.port_a_data_width = 1,
		ram_block11a_31.port_a_first_address = 0,
		ram_block11a_31.port_a_first_bit_number = 31,
		ram_block11a_31.port_a_last_address = 2047,
		ram_block11a_31.port_a_logical_ram_depth = 2048,
		ram_block11a_31.port_a_logical_ram_width = 32,
		ram_block11a_31.port_b_address_clear = "clear1",
		ram_block11a_31.port_b_address_clock = "clock1",
		ram_block11a_31.port_b_address_width = 11,
		...
		ram_block11a_31.port_b_last_address = 2047,
		ram_block11a_31.port_b_logical_ram_depth = 2048,
		ram_block11a_31.port_b_logical_ram_width = 32,
...
`endif
	...
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe12a <= {12{1'b1}};
		else if (clrn == 1'b0) dffe12a <= 12'b0;
		else if  (ena == 1'b1)   dffe12a <= (d & {12{(~ sclr)}});
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe12a,
		sclr = 1'b0;
endmodule //fifo_eth_8w32r_dffpipe


//dffpipe DELAY=2 WIDTH=12 clock clrn d q ALTERA_INTERNAL_OPTIONS=X_ON_VIOLATION_OPTION=OFF;SYNCHRONIZER_IDENTIFICATION=FORCED_IF_ASYNCHRONOUS
//VERSION_BEGIN 13.1 cbx_a_gray2bin 2013:10:23:18:05:48:SJ cbx_a_graycounter 2013:10:23:18:05:48:SJ cbx_altdpram 2013:10:23:18:05:48:SJ cbx_altsyncram 2013:10:23:18:05:48:SJ cbx_cycloneii 2013:10:23:18:05:48:SJ cbx_dcfifo 2013:10:23:18:05:48:SJ cbx_fifo_common 2013:10:23:18:05:48:SJ cbx_lpm_add_sub 2013:10:23:18:05:48:SJ cbx_lpm_compare 2013:10:23:18:05:48:SJ cbx_lpm_counter 2013:10:23:18:05:48:SJ cbx_lpm_decode 2013:10:23:18:05:48:SJ cbx_lpm_mux 2013:10:23:18:05:48:SJ cbx_mgl 2013:10:23:18:06:54:SJ cbx_scfifo 2013:10:23:18:05:48:SJ cbx_stratix 2013:10:23:18:05:48:SJ cbx_stratixii 2013:10:23:18:05:48:SJ cbx_stratixiii 2013:10:23:18:05:48:SJ cbx_stratixv 2013:10:23:18:05:48:SJ cbx_util_mgl 2013:10:23:18:05:48:SJ  VERSION_END
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF"} *)
module  fifo_eth_8w32r_dffpipe1
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe14a <= {12{1'b1}};
		else if (clrn == 1'b0) dffe14a <= 12'b0;
		else if  (ena == 1'b1)   dffe14a <= (d & {12{(~ sclr)}});
	// synopsys translate_off
	initial
		dffe15a = 0;
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe15a <= (dffe14a & {12{(~ sclr)}});
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe15a,
		sclr = 1'b0;
endmodule //fifo_eth_8w32r_dffpipe1
...
module  fifo_eth_8w32r_alt_synch_pipe
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	wire  [11:0]   wire_dffpipe13_q;

	fifo_eth_8w32r_dffpipe1   dffpipe13
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe13_q;
endmodule //fifo_eth_8w32r_alt_synch_pipe
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF"} *)
module  fifo_eth_8w32r_dffpipe12
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe17a <= {12{1'b1}};
		else if (clrn == 1'b0) dffe17a <= 12'b0;
		else if  (ena == 1'b1)   dffe17a <= (d & {12{(~ sclr)}});
	// synopsys translate_off
	initial
		dffe18a = 0;
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe18a <= (dffe17a & {12{(~ sclr)}});
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe18a,
		sclr = 1'b0;
endmodule //fifo_eth_8w32r_dffpipe12
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"X_ON_VIOLATION_OPTION=OFF;SYNCHRONIZER_IDENTIFICATION=FORCED_IF_ASYNCHRONOUS"} *)
module  fifo_eth_8w32r_alt_synch_pipe1
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	wire  [11:0]   wire_dffpipe16_q;

	fifo_eth_8w32r_dffpipe12   dffpipe16
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe16_q;
endmodule //fifo_eth_8w32r_alt_synch_pipe1


//lpm_add_sub DEVICE_FAMILY="Cyclone IV E" LPM_DIRECTION="SUB" LPM_WIDTH=12 dataa datab result
...
//lpm_compare DEVICE_FAMILY="Cyclone IV E" LPM_WIDTH=12 aeb dataa datab
...
endmodule //fifo_eth_8w32r_cmpr

//synthesis_resources = lut 26 M9K 8 reg 164 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF;REMOVE_DUPLICATE_REGISTERS=OFF;SYNCHRONIZER_IDENTIFICATION=OFF;SYNCHRONIZATION_REGISTER_CHAIN_LENGTH = 2;suppress_da_rule_internal=d101;suppress_da_rule_internal=d102;suppress_da_rule_internal=d103;-name CUT ON -from rdptr_g -to ws_dgrp|fifo_eth_8w32r_dffpipe12:dffpipe16|dffe17a;-name SDC_STATEMENT \"set_false_path -from *rdptr_g* -to *ws_dgrp|fifo_eth_8w32r_dffpipe12:dffpipe16|dffe17a* \";-name CUT ON -from delayed_wrptr_g -to rs_dgwp|fifo_eth_8w32r_dffpipe1:dffpipe13|dffe14a;-name SDC_STATEMENT \"set_false_path -from *delayed_wrptr_g* -to *rs_dgwp|fifo_eth_8w32r_dffpipe1:dffpipe13|dffe14a* \""} *)
module  fifo_eth_8w32r_dcfifo
	( 
	aclr,
	data,
	q,
...
`endif
	...
	wire	[11:0]	wire_rdusedw_sub_dataa;
	wire	[11:0]	wire_rdusedw_sub_datab;
	wire	[11:0]	wire_rdusedw_sub_result;
	wire	[11:0]	wire_wrusedw_sub_dataa;
	wire	[11:0]	wire_wrusedw_sub_datab;
	wire	[11:0]	wire_wrusedw_sub_result;
	wire  wire_rdempty_eq_comp_aeb;
	wire  wire_wrfull_eq_comp_aeb;
	wire  int_rdempty;
	wire  int_wrfull;
	wire  [10:0]  ram_address_a;
	wire  [10:0]  ram_address_b;
	wire  valid_rdreq;
	wire  valid_wrreq;
	wire  [11:0]  wrptr_gs;

	fifo_eth_8w32r_a_gray2bin   rdptr_g_gray2bin
	( 
	.bin(wire_rdptr_g_gray2bin_bin),
	.gray(rdptr_g[11:0]));
	fifo_eth_8w32r_a_gray2bin   rs_dgwp_gray2bin
	( 
	.bin(wire_rs_dgwp_gray2bin_bin),
	.gray(wire_rs_dgwp_q[11:0]));
	fifo_eth_8w32r_a_gray2bin   wrptr_g_gray2bin
	( 
	.bin(wire_wrptr_g_gray2bin_bin),
	.gray(wrptr_g[11:0]));
	fifo_eth_8w32r_a_gray2bin   ws_dgrp_gray2bin
	( 
	.bin(wire_ws_dgrp_gray2bin_bin),
	.gray(wire_ws_dgrp_q[11:0]));
	fifo_eth_8w32r_a_graycounter   rdptr_g1p
	( 
	.aclr(aclr),
	.clock(rdclk),
	.cnt_en(valid_rdreq),
	.q(wire_rdptr_g1p_q));
	fifo_eth_8w32r_a_graycounter1   wrptr_g1p
	( 
	.aclr(aclr),
	.clock(wrclk),
	.cnt_en(valid_wrreq),
	.q(wire_wrptr_g1p_q));
	fifo_eth_8w32r_altsyncram   fifo_ram
	( 
	.aclr1(aclr),
	...
	fifo_eth_8w32r_dffpipe   rs_brp
	( 
	.clock(rdclk),
	.clrn((~ aclr)),
	.d(wire_rdptr_g_gray2bin_bin),
	.q(wire_rs_brp_q));
	fifo_eth_8w32r_dffpipe   rs_bwp
	( 
	.clock(rdclk),
	.clrn((~ aclr)),
	.d(wire_rs_dgwp_gray2bin_bin),
	.q(wire_rs_bwp_q));
	fifo_eth_8w32r_alt_synch_pipe   rs_dgwp
	( 
	.clock(rdclk),
	.clrn((~ aclr)),
	.d(delayed_wrptr_g),
	.q(wire_rs_dgwp_q));
	fifo_eth_8w32r_dffpipe   ws_brp
	( 
	.clock(wrclk),
	.clrn((~ aclr)),
	.d(wire_ws_dgrp_gray2bin_bin),
	.q(wire_ws_brp_q));
	fifo_eth_8w32r_dffpipe   ws_bwp
	( 
	.clock(wrclk),
	.clrn((~ aclr)),
	.d(wire_wrptr_g_gray2bin_bin),
	.q(wire_ws_bwp_q));
	fifo_eth_8w32r_alt_synch_pipe1   ws_dgrp
	( 
	.clock(wrclk),
	.clrn((~ aclr)),
	.d(rdptr_g),
	...
	fifo_eth_8w32r_cmpr   rdempty_eq_comp
	( 
	.aeb(wire_rdempty_eq_comp_aeb),
	.dataa(wire_rs_dgwp_q),
	.datab(rdptr_g));
	fifo_eth_8w32r_cmpr   wrfull_eq_comp
	( 
	...
	assign
		...
		q = wire_fifo_ram_q_b,
		ram_address_a = {(wrptr_g[11] ^ wrptr_g[10]), wrptr_g[9:0]},
		ram_address_b = {(wire_rdptr_g1p_q[11] ^ wire_rdptr_g1p_q[10]), wire_rdptr_g1p_q[9:0]},
		rdempty = int_rdempty,
		rdusedw = {wire_rdusedw_sub_result[10:0]},
		valid_rdreq = (rdreq & (~ int_rdempty)),
		valid_wrreq = (wrreq & (~ int_wrfull)),
		wrfull = int_wrfull,
		wrptr_gs = {(~ wrptr_g[11]), (~ wrptr_g[10]), wrptr_g[9:0]},
		wrusedw = {wire_wrusedw_sub_result[10:0]};
endmodule //fifo_eth_8w32r_dcfifo
//VALID FILE
...
`endif
	...
	fifo_eth_8w32r_dcfifo	fifo_eth_8w32r_dcfifo_component (
				.rdclk (rdclk),
				.wrclk (wrclk),
				.wrreq (wrreq),
				.aclr (aclr),
