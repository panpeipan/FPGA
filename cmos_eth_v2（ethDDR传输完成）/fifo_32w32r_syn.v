...
module  fifo_32w32r_a_gray2bin
	...
	assign
		...
		xor7 = (gray[7] ^ xor8),
		xor8 = (gray[9] ^ gray[8]);
endmodule //fifo_32w32r_a_gray2bin


//a_graycounter DEVICE_FAMILY="Cyclone IV E" PVALUE=1 WIDTH=10 aclr clock cnt_en q
...
module  fifo_32w32r_a_graycounter
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sclr = 1'b0,
		updown = 1'b1;
endmodule //fifo_32w32r_a_graycounter
...
module  fifo_32w32r_a_graycounter1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sclr = 1'b0,
		updown = 1'b1;
endmodule //fifo_32w32r_a_graycounter1


//altsyncram ADDRESS_ACLR_B="CLEAR1" ADDRESS_REG_B="CLOCK1" CLOCK_ENABLE_INPUT_B="BYPASS" DEVICE_FAMILY="Cyclone IV E" OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="CLEAR1" OUTDATA_REG_B="CLOCK1" WIDTH_A=32 WIDTH_B=32 WIDTH_BYTEENA_A=1 WIDTHAD_A=9 WIDTHAD_B=9 aclr1 address_a address_b addressstall_b clock0 clock1 clocken1 data_a q_b wren_a
...
endmodule //fifo_32w32r_altsyncram
...
`endif
	...
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe12a <= {10{1'b1}};
		else if (clrn == 1'b0) dffe12a <= 10'b0;
		else if  (ena == 1'b1)   dffe12a <= (d & {10{(~ sclr)}});
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe12a,
		sclr = 1'b0;
endmodule //fifo_32w32r_dffpipe
...
`endif
	...
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe15a <= (dffe14a & {10{(~ sclr)}});
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe15a,
		sclr = 1'b0;
endmodule //fifo_32w32r_dffpipe1
...
module  fifo_32w32r_alt_synch_pipe
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	wire  [9:0]   wire_dffpipe13_q;

	fifo_32w32r_dffpipe1   dffpipe13
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe13_q;
endmodule //fifo_32w32r_alt_synch_pipe
...
`endif
	...
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe16a <= {1{1'b1}};
		else if (clrn == 1'b0) dffe16a <= 1'b0;
		else if  (ena == 1'b1)   dffe16a <= (d & (~ sclr));
	// synopsys translate_off
	initial
		dffe17a = 0;
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe17a <= (dffe16a & (~ sclr));
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe17a,
		sclr = 1'b0;
endmodule //fifo_32w32r_dffpipe12
...
`endif
	...
	assign
		...
		q = dffe20a,
		sclr = 1'b0;
endmodule //fifo_32w32r_dffpipe123
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"X_ON_VIOLATION_OPTION=OFF;SYNCHRONIZER_IDENTIFICATION=FORCED_IF_ASYNCHRONOUS"} *)
module  fifo_32w32r_alt_synch_pipe1
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	fifo_32w32r_dffpipe123   dffpipe18
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe18_q;
endmodule //fifo_32w32r_alt_synch_pipe1
...
endmodule //fifo_32w32r_cmpr

//synthesis_resources = lut 11 M9K 2 reg 120 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF;REMOVE_DUPLICATE_REGISTERS=OFF;SYNCHRONIZER_IDENTIFICATION=OFF;SYNCHRONIZATION_REGISTER_CHAIN_LENGTH = 2;suppress_da_rule_internal=d101;suppress_da_rule_internal=d102;suppress_da_rule_internal=d103;suppress_da_rule_internal=R105;-name CUT ON -from rdptr_g -to ws_dgrp|fifo_32w32r_dffpipe123:dffpipe18|dffe19a;-name SDC_STATEMENT \"set_false_path -from *rdptr_g* -to *ws_dgrp|fifo_32w32r_dffpipe123:dffpipe18|dffe19a* \";-name CUT ON -from delayed_wrptr_g -to rs_dgwp|fifo_32w32r_dffpipe1:dffpipe13|dffe14a;-name SDC_STATEMENT \"set_false_path -from *delayed_wrptr_g* -to *rs_dgwp|fifo_32w32r_dffpipe1:dffpipe13|dffe14a* \""} *)
module  fifo_32w32r_dcfifo
	( 
	aclr,
	data,
	q,
...
`endif
	...
	fifo_32w32r_a_gray2bin   rdptr_g_gray2bin
	( 
	.bin(wire_rdptr_g_gray2bin_bin),
	.gray(rdptr_g[9:0]));
	fifo_32w32r_a_gray2bin   rs_dgwp_gray2bin
	( 
	.bin(wire_rs_dgwp_gray2bin_bin),
	.gray(wire_rs_dgwp_q[9:0]));
	fifo_32w32r_a_graycounter   rdptr_g1p
	( 
	.aclr(aclr),
	.clock(rdclk),
	.cnt_en(valid_rdreq),
	.q(wire_rdptr_g1p_q));
	fifo_32w32r_a_graycounter1   wrptr_g1p
	( 
	.aclr((~ wire_wraclr_q)),
	.clock(wrclk),
	.cnt_en(valid_wrreq),
	.q(wire_wrptr_g1p_q));
	fifo_32w32r_altsyncram   fifo_ram
	( 
	.aclr1(aclr),
	...
	fifo_32w32r_dffpipe   rs_brp
	( 
	.clock(rdclk),
	.clrn((~ aclr)),
	.d(wire_rdptr_g_gray2bin_bin),
	.q(wire_rs_brp_q));
	fifo_32w32r_dffpipe   rs_bwp
	( 
	.clock(rdclk),
	.clrn((~ aclr)),
	.d(wire_rs_dgwp_gray2bin_bin),
	.q(wire_rs_bwp_q));
	fifo_32w32r_alt_synch_pipe   rs_dgwp
	( 
	.clock(rdclk),
	.clrn((~ aclr)),
	.d(delayed_wrptr_g),
	.q(wire_rs_dgwp_q));
	fifo_32w32r_dffpipe12   wraclr
	( 
	.clock(wrclk),
	.clrn((~ aclr)),
	.d(1'b1),
	.q(wire_wraclr_q));
	fifo_32w32r_alt_synch_pipe1   ws_dgrp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(rdptr_g),
	...
	fifo_32w32r_cmpr   rdempty_eq_comp
	( 
	.aeb(wire_rdempty_eq_comp_aeb),
	.dataa(wire_rs_dgwp_q),
	.datab(rdptr_g));
	fifo_32w32r_cmpr   rdfull_eq_comp
	( 
	.aeb(wire_rdfull_eq_comp_aeb),
	.dataa(wire_rs_dgwp_q),
	.datab(rdptr_gs));
	fifo_32w32r_cmpr   wrfull_eq_comp
	( 
...
module fifo_32w32r (
	...
	rdempty,
	rdfull,
	rdusedw)/* synthesis synthesis_clearbox = 1 */;
...
`endif
	...
	fifo_32w32r_dcfifo	fifo_32w32r_dcfifo_component (
				.rdclk (rdclk),
				.wrclk (wrclk),
				.wrreq (wrreq),
				.aclr (aclr),
